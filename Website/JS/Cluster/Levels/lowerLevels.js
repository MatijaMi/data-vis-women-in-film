...
import{findProfessionPicture,createLines,determineJobSize,clearPrevDataviz,addPatterns,determinePersonSize,determineSubgroupY} from '../Util/bubbleUtil.js';
  ...
  var simulation = d3.forceSimulation()
    ...
    if(furtherSubgroups.length>0 && profession!="Other"){
        ...
        var subgroupNodes = PanelSVG.append("g")
            ...
            .attr("r", function (d) { return determineJobSize(d.count,furtherSubgroups)})
            .attr("cx", 125)
